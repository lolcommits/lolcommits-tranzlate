...
[Fork](https://guides.github.com/activities/forking) then clone the repository:
    ...
    git clone git@github.com:your-username/lolcommits-tranzlate.git
...
Request](https://github.com/lolcommits/lolcommits-tranzlate/compare):
...
* If you are fixing an
  [issue](https://github.com/lolcommits/lolcommits-tranzlate/issues), link to
